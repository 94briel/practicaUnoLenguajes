...
class LSL:
    ...
    # Método para agregar elementos al inicio de la LSL
    def anadir_al_inicio(self, clase, dato):
        nuevo_nodo = NodoSimple(clase=clase, dato=dato, liga=self.primero)
        if self.es_vacia():
    ...
    def anadir_al_final(self, clase, dato):
